package com.netease.spiderSchedule.sort;
...
public class MaxHeap<E extends Comparable<E>> {
	...
	public static void main(String[] args) {
		...
		for(int i =0; i< 10; i++){
			SpiderScheduleDto spiderScheduleDto = new SpiderScheduleDto();
			spiderScheduleDto.setSourceId("sourceid" + i);
			spiderScheduleDto.setScore(i*100);
			heapSort.add(spiderScheduleDto);
		}
		
		SpiderScheduleDto spiderScheduleDto = new SpiderScheduleDto();
		spiderScheduleDto.setSourceId("sourceid" + 5);
		spiderScheduleDto.setScore(5*100+50);
		heapSort.add(spiderScheduleDto);
		for (int i = 0; i < 10; i++) {
		System.err.println(heapSort.removeTop());
		}
